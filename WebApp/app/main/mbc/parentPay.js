...
angular.module('app')
.controller('ParentPayCtrl', ['$rootScope', '$scope', '$state', '$stateParams','globalConstants','NotificationService','StateDataService','TempOrderDataService','OrderDataService', '$location',
    function ($rootScope, $scope, $state,$stateParams,globalConstants,NotificationService,StateDataService,TempOrderDataService,OrderDataService, $location) {
