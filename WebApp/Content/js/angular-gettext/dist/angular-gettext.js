    ...
    catalog = {
        ...
        setStrings: function (language, strings) {
            ...
            for (var key in strings) {
                ...
                this.strings[language][key.replace(/\r?\n|\r/g, '')] = val;
            }
...
angular.module('gettext').directive('trns', ["gettextCatalog", "$parse", "$animate", "$compile", "$window", function (gettextCatalog, $parse, $animate, $compile, $window) {
    ...
    return {
        ...
        compile: function compile(element, attrs) {
            // Validate attributes
            assert(!attrs.translatePlural || attrs.translateN, 'trns-n', 'trns-plural');
            assert(!attrs.translateN || attrs.translatePlural, 'trns-plural', 'trns-n');
            ...
            return {
                post: function (scope, element, attrs) {
                    ...
                    if (attrs.trnsN) {
                        scope.$watch(attrs.trnsN, update);
                    }
...
angular.module('gettext').filter('trns', ["gettextCatalog", function (gettextCatalog) {
